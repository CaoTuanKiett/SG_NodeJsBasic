...
const userRouter = (app) => {
  ...
  router.post('/users/register', awaitHandlerFactory(userController.register)); // localhost:3000/api/v1/users/register

  router.post('/users/login', awaitHandlerFactory(userController.login)); // localhost:3000/api/v1/users/login
